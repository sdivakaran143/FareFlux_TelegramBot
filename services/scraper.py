    ...
    for bus in all_inventories:
        ...
        try:
            ...
            if campaign.get("Vld"):
                ...
                discounted_prices = cmpg.get(
                    "DiscountedPrices",
                    []
                )

                original_prices = cmpg.get(
                    "OriginalPrices",
                    []
                )

                if discounted_prices:
                    discounted_price = min(discounted_prices)

                if original_prices:
                    original_price = min(original_prices)
